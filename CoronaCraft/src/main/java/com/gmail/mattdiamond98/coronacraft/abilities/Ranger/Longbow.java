...
public class Longbow extends Ability implements Listener {
    ...
    public void initialize() {
        styles.add(new DippedArrow());
        styles.add(new HeavyArrow());
        styles.add(new BodkinArrow());
        styles.add(new BarbedArrow());
        styles.add(new BusterArrow());
    ...
    public void onBowShoot(EntityShootBowEvent e) {
        if (e.getProjectile() instanceof Arrow && e.getEntity() instanceof Player) {
            ...
            if (UltimateTracker.isUltimateActive(p)) {
                SlayingArrow.style.onShoot(arrow);
            }
